...
export const MaterialSwitchListItem = ({
  ...
  const handleStyle = useAnimatedStyle(() =>
    disabled
      ...
      : {
          ...
          minHeight: switchOffIcon ? 24 : 16,
          minWidth: switchOffIcon ? 24 : 16,
          backgroundColor: interpolateColor(position.value, [-10, 10], [theme.colors.outline, theme.colors.onPrimary]),
          borderRadius: 20,
          justifyContent: "center",
          alignItems: "center",
        },
  ...
  const trackStyle = useAnimatedStyle(() =>
    disabled
      ...
      : {
          ...
          borderColor: interpolateColor(position.value, [-10, 10], [theme.colors.outline, theme.colors.primary]),
          borderWidth: 2,
          borderRadius: 16,
          justifyContent: "center",
          height: 32,
  ...
  const onTap = () => {
    if (active) {
      ...
      position.value = withTiming(-10, { duration: 250, easing: Easing.out(Easing.poly(1.4)) }, (finished) => {
        "worklet";
  ...
  return (
    <List.Item
      left={() => (leftIcon ? <List.Icon style={{ paddingRight: leftIcon ? 8 : 0 }} icon={leftIcon} /> : null)}
